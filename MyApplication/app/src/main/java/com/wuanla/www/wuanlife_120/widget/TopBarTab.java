...
public class TopBarTab  extends FrameLayout {
    ...
    public TopBarTab(Context context, @DrawableRes int icon) {
        this(context, null, icon);
    }

    public TopBarTab(Context context, AttributeSet attrs, int icon) {
        this(context, attrs, 0, icon);
    }

    public TopBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon) {
