        ...
        if (arraylist.size()==0){
            ...
            //Log.e("arraylist.size()",arraylist.size()+"");
                if (convertView == null) {
                    ...
                    viewHolder.home_posts_image01 = (ImageView) convertView.findViewById(R.id.image01);
                    viewHolder.home_posts_image02 = (ImageView) convertView.findViewById(R.id.image02);
                    viewHolder.home_posts_image03 = (ImageView) convertView.findViewById(R.id.image03);
